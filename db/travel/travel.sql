...
CREATE TABLE `foot_spot` (
                             ...
                             `visit_type` VARCHAR(20) NOT NULL DEFAULT 'travel' COMMENT 'travel旅行/transit途经',
                             `visit_time` DATE DEFAULT NULL COMMENT '到访日期',
                             `longitude` DECIMAL(10,7) DEFAULT NULL COMMENT 'WGS84经度',
                             `latitude` DECIMAL(10,7) DEFAULT NULL COMMENT 'WGS84纬度',
                             `travel_note` VARCHAR(1000) DEFAULT NULL COMMENT '旅行心得',
                             `image_url` VARCHAR(500) DEFAULT NULL COMMENT '地点缩略图地址',
                             `create_time` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
                             `update_time` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
                             PRIMARY KEY (`spot_id`),
...
INSERT INTO `train` (
    train_id, user_id, train_no, train_type, train_model,
    ...
    departure_datetime, arrival_datetime, seat_no, seat_class, mileage_km
      ...
      (1, 1, 'G824/G821',    '高速动车', 'CRH380AL',   '西安北',   '广州南',   '西安北',   '深圳北',   '2023-08-08 09:56:00', '2023-08-08 19:16:00', '10车12B',        '二等座',     NULL),
      (2, 1, 'G6215',        '高速动车', 'CR400AF',    '广州南',   '深圳北',   '广州南',   '深圳北',   '2023-08-11 15:43:00', '2023-08-11 16:19:00', '10车03B',        '二等座',     NULL),
      (3, 1, 'G115',         '高速动车', 'CRH380B',    '南京南',   '上海虹桥', '北京南',   '杭州东',   '2016-07-18 13:41:00', '2016-07-18 14:48:00', '14车11A',        '二等座',     NULL),
      (4, 1, 'D2696',        '动车',     'CRH5G',      '咸阳西',   '西安北',   '嘉峪关南', '西安北',   '2023-10-03 17:30:00', '2023-10-03 17:34:00', '07车18A',        '二等座',     NULL),
      (5, 1, 'D216',         '动车',     'CR200J3-C',  '南京',     '西安',     '上海',     '兰州',     '2025-04-01 19:47:00', '2025-04-02 07:49:00', '05车11上铺',    '二等卧',     NULL),
      (6, 1, 'G2064',        '高速动车', 'CRH380B',    '西安北',   '青岛',     '西安北',   '青岛',     '2025-07-23 09:37:00', '2025-07-23 15:50:00', '06车04A',        '二等座',     NULL),
      (7, 1, 'G1855',        '高速动车', 'CRH381B',    '青岛北',   '西安北',   '青岛北',   '西安北',   '2025-07-27 13:43:00', '2025-07-27 21:21:00', '06车03A',        '二等座',     NULL),
      (8, 1, 'K912',         '快速列车', NULL,         '西安',     '济南',     '西安',     '青岛',     '2019-07-23 12:12:00', '2019-07-24 05:20:00', '14车004号上铺', '新空调硬卧', NULL),
      (9, 1, 'K911',         '快速列车', NULL,         '兖州',     '西安',     '青岛',     '西安',     '2019-07-28 18:21:00', '2019-07-29 11:39:00', '13车002号上铺', '新空调硬卧', NULL),
      (10, 1, 'D124',        '动车',     'CR200J1-C',  '西安',     '南京',     '西安',     '上海',     '2025-08-25 21:16:00', '2025-08-26 09:27:00', '14车019号下铺','二等卧',     NULL),
      (11, 1, 'G1928/G1929', '高速动车', 'CRH380AL',   '南京南',   '西安北',   '上海虹桥', '西安北',   '2026-02-08 14:00:00', '2026-02-08 20:00:00', '07车06F',        '二等座',     NULL),
      (12, 1, 'G96/G93',     '高速动车', 'CR400BF-S',  '西安北',   '南京南',   '西安北',   '上海虹桥', '2026-03-01 15:32:00', '2026-03-01 20:19:00', '02车04F',        '二等座',     NULL),
      (13, 1, 'G7431',       '高速动车', 'CRH380B',    '南京南',   '苏州北',   '合肥南',   '温州南',   '2026-04-04 09:23:00', '2026-04-04 10:27:00', '13车10D',        '二等座',     NULL),
      (14, 1, 'Z164',        '直快列车', '25T',        '苏州',     '南京南',   '上海',     '拉萨',     '2026-04-05 19:24:00', '2026-04-05 21:13:00', '12车19号上铺',  '硬卧',       NULL),
      (15, 1, 'G94/G95',     '高速动车', 'CR400BF-A',  '南京南',   '西安北',   '上海虹桥', '西安北',   '2026-08-01 09:56:00', '2026-08-01 14:34:00', '03车04F',        '二等座',     NULL),
      (16, 1, 'G3839',       '高速动车', 'CR400BF-Z',  '西安东',   '西安北',   '南阳东',   '西安北',   '2026-08-10 13:30:00', '2026-08-10 13:54:00', '06车18D',        '二等座',     NULL),
      (17, 1, 'G2196',       '高速动车', 'CR400BF-Z',  '西安北',   '南京南',   '延安',     '上海虹桥', '2026-08-23 12:10:00', '2026-08-23 17:44:00', '03车08F',        '二等座',     NULL);
